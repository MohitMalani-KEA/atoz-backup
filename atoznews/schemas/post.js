    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          hidden: ({ document }) => document?.updateContent.url,
          description:
            'All update content goes here. All formatting, hyperlinks, etc. will appear on the site as you see them here. For the time being, keep image use minimalistic.',
        },
      ],
    },
  ],
