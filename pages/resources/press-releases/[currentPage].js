...
import { newsQueryPress } from '../../../src/queries'
...
import bgImage from '../../../public/backgrounds/print2-bg.svg'
    ...
    <>
      ...
      <MainWrap>
        ...
        <ContentBlock
          ...
          subtitle='The latest ATOZ announcements'>
...
export const getStaticPaths = async () => {
  const updates = await sanityClient.fetch(newsQueryPress)
